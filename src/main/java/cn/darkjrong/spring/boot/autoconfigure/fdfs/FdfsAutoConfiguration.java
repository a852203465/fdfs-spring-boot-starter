...
import cn.darkjrong.fdfs.FastDFSUtils;
...
public class FdfsAutoConfiguration {
    ...
    @Bean
    public FastDFSUtils fastDFSUtils(FastFileStorageClient storageClient,
                                     AppendFileStorageClient appendFileStorageClient,
                                     ThumbImageConfig thumbImageConfig,
                                     FdfsWebServer fdfsWebServer,
                                     TrackerClient trackerClient) {
        return new FastDFSUtils(trackerClient, storageClient, appendFileStorageClient, thumbImageConfig, fdfsWebServer);
    }
