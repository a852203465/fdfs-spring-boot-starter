...
import cn.darkjrong.fdfs.exception.ExceptionEnum;
...
public class FastDFSUtils {
    ...
    public FastDFSUtils(TrackerClient trackerClient, FastFileStorageClient storageClient,
    ...
    public String uploadImageAndCrtThumbImage(MultipartFile file, Boolean identifier, Map<String, String> metadataMap) throws FdfsException {
        ...
        try {
            ...
            logger.error("uploadImageAndCrtThumbImage {}", e.getMessage());
            throw new FdfsException(e.getMessage());
        }finally {
            IoUtil.close(inputStream);
        }
    ...
    public StorePath uploadAppenderFile(File file) throws FdfsException {
        ...
        if (!FileUtil.exist(file)) {
            ...
            throw new IllegalArgumentException(ExceptionEnum.FILE_NOT_FOUND.getValue());
        }
    ...
    public StorePath uploadAppenderFile(MultipartFile file) throws FdfsException {
        ...
        try {
            ...
            logger.error("uploadAppenderFile {}", e.getMessage());
            throw new FdfsException(e.getMessage());
        }finally {
            IoUtil.close(inputStream);
        }
    ...
    public void appendFile(StorePath storePath, File file, Long historyUpload) throws FdfsException {
        ...
        if (!FileUtil.exist(file)) {
            logger.error("The appended file does not exist");
            throw new IllegalArgumentException(ExceptionEnum.THE_APPENDED_FILE_DOES_NOT_EXIST.getValue());
        }
    ...
    public byte[] downFile(String filePath) throws FdfsException {
        ...
        try {
            ...
            logger.error("downFile {}", e.getMessage());
            throw new FdfsException(e.getMessage());
        }
