...
public class FastDFSTest {
    ...
    public void before() {
        ...
        fastDFSUtils = new FastDFSUtils(trackerClient, fastFileStorageClient, appendFileStorageClient, thumbImageConfig, fdfsWebServer);
    }

    @Test
    public void uploadFile() {

        String uploadFile = fastDFSUtils.uploadFile(new File("F:\\我的图片\\美女\\1.jpg"), true);
